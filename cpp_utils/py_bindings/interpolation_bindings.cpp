...
void bind_interpolation(pybind11::module_ &m) {
    ...
    py::class_<sdrlib::interpolation::CubicFarrowInterpolator>(m, "CubicFarrowInterpolator")
        .def(py::init<>())
        .def("reset", &sdrlib::interpolation::CubicFarrowInterpolator::reset)
        .def("load", py::overload_cast<sdrlib::cpx>(&sdrlib::interpolation::CubicFarrowInterpolator::load))
        .def("load", 
            [](sdrlib::interpolation::CubicFarrowInterpolator &self, py::array_t<sdrlib::cpx> pyarr_in){
        ...
        .def("process", 
            [](sdrlib::interpolation::CubicFarrowInterpolator &self, py::array_t<sdrlib::cpx> pyarr_in, py::array_t<sdrlib::cpx> pyarr_out, float frac_off, int int_off){
        ...
        py::arg("buffer_in"), py::arg("buffer_out"), py::arg("fractional_offset"), py::arg("integer_offset") = 0);
